...
const HEADERS_DEF_LINE_PHYS = ['自分ステータス', '結果1', '自分特性', '自分テラスタル', '自分持ち物', '相手', '相手ステータス', '技', '特化', '結果2', '無補正252', '結果3', '場の状態'];
const HEADERS_DEF_LINE_SPEC = ['自分ステータス', '結果1', '自分特性', '自分テラスタル', '自分持ち物', '相手', '相手ステータス', '技', '特化', '結果2', '無補正252', '結果3', '場の状態'];
